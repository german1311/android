...
import com.example.davidruiz.myapplication.R;
...
public class BirthdayPickerPopWin extends PopupWindow implements View.OnClickListener {
    ...
    public static class Builder{
        ...
        //Option
        private boolean showDayMonth = false;
        private String textCancel = "Cancel";
        private String textConfirm = "Confirm";
        private String dateChose = getStrDate();
        private int colorCancel = Color.parseColor("#BF0206");
        ...
        public BirthdayPickerPopWin build(){
            return new BirthdayPickerPopWin(this);
        }

        public Builder showDayMonth(boolean useDayMonth) {
            this.showDayMonth = useDayMonth;
            return this;
        }
    }

    public BirthdayPickerPopWin(Builder builder){
        ...
        this.showDayMonth = builder.showDayMonth;
    ...
    private void initView() {
        ...
        contentView = LayoutInflater.from(mContext).inflate(showDayMonth ? R.layout.layout_birthday_picker_inverted : R.layout.layout_birthday_picker, null);
...
//
    ...
    private void initPickerViews() {
        ...
        for (int i = 0; i < months.length; i++) {
            ...
            monthList.add(months[i].substring(0,3) + ".");
        }
    ...
    public void onClick(View v) {
        ...
        if (v == contentView || v == cancelBtn) {
            ...
            if (null != mListener) {
                ...
                mListener.onDatePickCompleted(0, month, day, sb.toString());
            }
